...
class ConsultaController extends Controller
{
    ...
    public function cancelar($id){
        ...
        Mail::to('humberto.zeferino@escolar.ifrn.edu.br')->send(new ConsultaCancelada($consulta));
    ...
    public function rejeitar($id) {
        ...
        Mail::to('humberto.zeferino@escolar.ifrn.edu.br')->send(new ConsultaRejeitada($consulta));
