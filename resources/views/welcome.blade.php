...
@section('content')
    ...
    <section class="banner">
        <div class="banner-content">
            ...
            <br>
            <br>
            <!-- id="search" name="search" class="form-control me-2" -->

            <div id="search-container-agenda" class="col-md-12">
                <p>Já tem uma consulta agendada? Busque aqui:</p>
                <form action="{{ route('consultas') }}" method="GET" class="d-flex mb-3 align-items-center">
                    <input type="text" placeholder= "Digite aqui informações da sua consulta:"
